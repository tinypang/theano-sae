...
from logistic_sgd import LogisticRegression, shared_dataset, load_data
...
def evaluate_lenet5(path='../spectrogram/gs_3sec_spectrograms_33rd',learning_rate=0.1, n_epochs=200,nkerns=[20, 50], batch_size=500,dimx=57,dimy=36,pcancomps=100):
    ...
    print 'mnist'
    print train_set_x1.get_value(borrow=True).shape, train_set_y1.get_value(borrow=True).shape
    ...
    layer1 = LeNetConvPoolLayer(rng, input=layer0.output,
            image_shape=(batch_size, nkerns[0], (dimx-4)/2, (dimy-4)/2),
    ...
    layer2 = HiddenLayer(rng, input=layer2_input, n_in=nkerns[1] * (dimx-12)/4 * (dimy-12)/4,
